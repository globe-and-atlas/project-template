# Task: __PROJECT_NAME__

## Objective

Define the first real milestone for this `__PROFILE__` project.

## Context

- Deploy target: `__DEPLOY__`
- Runtime: `__RUNTIME__`
- Loop mode: `__LOOP_MODE__`
- Knowledge level: `__KNOWLEDGE_LEVEL__`
